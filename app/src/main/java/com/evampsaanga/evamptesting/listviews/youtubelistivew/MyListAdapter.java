...
public class MyListAdapter  extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        if(convertView == null)
        {
            ...
            convertView = layoutInflater.inflate(R.layout.childview_spiceexpandablelistivew, null);
        }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        {
            LayoutInflater layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.groupview_spiceexpandablelistivew, null);
        }

        TextView heading = (TextView) convertView.findViewById(R.id.tv_groupview_spiceexpandablelistivew_GroupHeading);
